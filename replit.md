...
## Recent Changes
- 2026-01-14: CRITICAL REGISTRY DATA AUDIT - AOANJRR survival rates (95.7% at 10yr) were for PRIMARY THA, not revision THA. This is inappropriate for H-34 (a revision study). Primary THA has ~95% 10yr survival vs revision THA ~82%. AOANJRR survival data EXCLUDED from benchmarking until revision-specific data is extracted from pages 230-280.
- 2026-01-14: BENCHMARKING DISPLAY FIX - Dashboard now uses best available survival timepoint for each registry. Valid registries: NJR (1yr=95.8%, 10yr=87.2%), SHAR (15yr=77.8%). AJRR/CJRR/AOANJRR show N/A (graphical-only or wrong population).
