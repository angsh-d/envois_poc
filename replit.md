...
## Recent Changes
- 2026-01-14: BENCHMARKING DISPLAY FIX - Fixed registry benchmark N/A values. Dashboard now uses best available survival timepoint for each registry (NJR: 1yr=95.8%, SHAR: 15yr=77.8%, AOANJRR: 10yr=95.7%). AJRR/CJRR correctly show N/A due to graphical-only data. Updated dashboard_service.py to dynamically select survival_1yr/2yr/5yr/10yr/15yr based on data availability.
